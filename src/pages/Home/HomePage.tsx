...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#C41E3A] to-[#A01830] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/commands">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#C41E3A]">
                  浏览教程
                </Button>
              </Link>
            </div>
        ...
        <section className="py-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                <p className="text-3xl font-bold text-[#C41E3A]">{progress.stats.totalTutorialsCompleted}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">已完成教程</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#C41E3A]">{progress.stats.totalStepsCompleted}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">已完成步骤</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#C41E3A]">{progress.stats.totalTimeSpent}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">学习时长(分钟)</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-[#FFD700]">
                  {Math.round(
                    (progress.stats.totalTutorialsCompleted / 4) * 100
                  )}%
                </p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mb-2">Cursor Tutorial - 快速入门指南</p>
            <p className="text-sm">使用 React + TypeScript + Tailwind CSS 构建</p>
          </div>
        </div>
      </footer>
    </div>
